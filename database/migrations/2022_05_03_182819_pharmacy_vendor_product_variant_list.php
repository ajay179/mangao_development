...
class PharmacyVendorProductVariantList extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         Schema::create('mangao_vendor_pharmacy_product_variant_list', function (Blueprint $table) {
            $table->id();
            $table->foreignId('vendor_id')->constrained('mangao_vendors','id');
            $table->foreignId('product_id')->constrained('mangao_vendor_pharmacy_product','id');
    ...
    {
         Schema::dropIfExists('mangao_vendor_pharmacy_product_variant_list');
    }
}
