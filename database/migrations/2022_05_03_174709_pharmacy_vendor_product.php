...
class PharmacyVendorProduct extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mangao_vendor_pharmacy_product', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mangao_vendor_pharmacy_product');
    }
}
