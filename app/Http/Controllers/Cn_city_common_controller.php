...
class Cn_city_common_controller extends Controller
{
    /**
     ...
     */
    public function delete_common_function_city_admin(Request $request)
    {
        if ($request->ajax()) {
            try {
    ...
    public function fun_cityadmin_change_user_status(Request $request)
    {
        if ($request->ajax()) {
            try {
