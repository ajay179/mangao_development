        ...
        <div class="row">
            <div class="col-md-4">
                <section class="content-header">
                    <h1>Add Pharmacy Product Variant  </h1>
                </section>

                <div class="box box-primary">
                    <div class="box-body light-green-body mob_min_height_auto">
                          <form method="POST" id="vendorPharmacyProductVariantForm" action="{{ route('vendor.add.pharmacy.product.variant.action') }}">
                          @csrf
                          ...
                          <div class="clearfix"></div>
                            <div  class="col-md-12 form-group no-padd">
                                <label>Quantity<span style="color: red;">*</span></label>
                                 <input type="text" class="form-control" placeholder="250/500/...." id="variant_quantity" name="variant_quantity" autocomplete="off" value="{{ !empty($product_single_variant_data_for_update[0]->variant_quantity) ? $product_single_variant_data_for_update[0]->variant_quantity : ''}}">

                            </div>

                            <div class="col-md-12 form-group no-padd">
                                <label>Unit<span style="color: red;">*</span></label>
                                <input type="text" class="form-control" id="variant_unit" placeholder="quator/half/full" name="variant_unit" autocomplete="off" value="{{ !empty($product_single_variant_data_for_update[0]->variant_unit) ? $product_single_variant_data_for_update[0]->variant_unit : '' }}">
                            </div>
