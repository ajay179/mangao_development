        ...
        <div class="row no-margin">
            <div class="col-md-12 no-pad">
                <section class="content-header">
                    ...
                    <h1>{{ !empty($product_data) ? 'Edit' : 'Add' }} PharmacyWW Product
                        <div class="pull-right">
                            <a href="{{ route('vendor.pharmacy.product') }}"><button type="button" class="btn btn-danger"><i class="fa fa-arrow-circle-left"></i> Back
                                </button></a>
                        </div>
                ...
                <section class="content" style="padding:5px 0px;">
                    <div class="box box-primary">
                        <div class="box-body light-green-body">
                            <form method='POST' id="vendorAddPharmacyProductForm" enctype='multipart/form-data' action="{{ route('vendor.add.pharmacy.product.action')}}" >
                            @csrf  
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6 form-group">
                                       <label>Quantity<span style="color: red;">*</span></label>
                                         <input type="text" class="form-control" placeholder="250/500...." id="quantity" name="quantity" autocomplete="off" value="{{ !empty($product_data[0]->quantity) ? $product_data[0]->quantity : ''}}">
                                    ...
                                    <div  class="col-md-6 form-group">
                                        ...
                                        <input type="text" class="form-control" id="unit" placeholder="Quator/half/full..." name="unit" autocomplete="off" value="{{ !empty($product_data[0]->unit) ? $product_data[0]->unit : '' }}">
