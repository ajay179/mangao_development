            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-body light-green-body mob_min_height_auto">
                          <form method="POST" id="vendorRestoProductVariantForm" action="{{ route('vendor.add.restaurant.product.variant.action') }}">
                          @csrf
