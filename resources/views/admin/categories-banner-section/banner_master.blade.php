                    ...
                    <div class="box-body light-green-body mob_min_height_auto">
                          ...
                          @csrf
                            ...
                            <div class="col-md-12 form-group no-padd">
                                ...
                                <input type="text" name="banner_position" id="banner_position" autocomplete="off" class="form-control" value="{{!empty($banner_data[0]->banner_position) ? $banner_data[0]->banner_position : ''}}">
                                             ...
                                             <thead>
                                                   <tr role="row">
                                                      ...
                                                      <th width="20%">Banner Name</th>
                                                       <th width="20%">Banner Position</th>
