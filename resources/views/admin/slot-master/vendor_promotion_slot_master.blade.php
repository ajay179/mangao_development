        ...
        <div class="row">
            <div class="col-md-4">
                <section class="content-header">
                    <h1>Add Vendor Promotion Time Slot </h1>
                </section>
            ...
            <div class="col-md-8 ">
                <section class="content-header">
                    <h1>Vendor Promotion Slot List </h1>
...
<script type="text/javascript">
    ...
    $(".vendor_slot_master_active").addClass("active");
...
<script type="text/javascript">
  // $(function () {
    let table = $('#example').dataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('master.time.slot.getDataTable','vendor_promotion') }}",
        columns: [
