            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-body light-green-body mob_min_height_auto">
                          <form method="POST" id="termForm" action="{{ route('cms.action')}}" >
                          @csrf
                        
                            <div class="col-md-12 form-group no-padd">
                                <label>Title<span style="color: red;">*</span></label>
                                <input type="text" name="title_name" id="title_name" autocomplete="off" class="form-control" value="Terms Condition" readonly>
                                <input type="hidden" name="txtpkey" id="txtpkey" value="{{!empty($term_data[0]->id) ? $term_data[0]->id : ''}}">
