                    ...
                    <div class="box-body light-green-body mob_min_height_auto">
                          ...
                          @csrf
                            ...
                            <div class="col-md-12 form-group no-padd">
                                ...
                                <input type="text" name="title_name" id="title_name" autocomplete="off" class="form-control" value="Return Cancellation Policy" readonly>
                            ...
                            <div class="col-md-12 form-group no-padd">
                                ...
                                <textarea  name="content_details" rows="6" id="content_details" autocomplete="off" class="form-control" value="{{!empty($policy_data[0]->content_details) ? $policy_data[0]->content_details : ''}}"> {{!empty($policy_data[0]->content_details) ? $policy_data[0]->content_details : ''}}</textarea>
...
<script type="text/javascript">
    ...
    $(".return_policy_active").addClass("active");
